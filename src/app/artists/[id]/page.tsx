...
export default async function ArtistPage({ params }: ArtistPageProps) {
  ...
  return (
    <>
      <Header />
      <div className="min-h-screen flex flex-col items-center justify-start bg-clr1 text-black p-4 md:p-10">
        ...
        <p className="mt-6 text-sm sm:text-base md:text-lg text-black max-w-2xl text-center leading-relaxed">
